...
class KatanaSessionPublishPlugin(HookBaseClass):
    ...
    def settings(self):
        ...
        base_settings = super(KatanaSessionPublishPlugin, self).settings or {}
    ...
    def validate(self, settings, item):
        ...
        return super(KatanaSessionPublishPlugin, self).validate(settings, item)
    ...
    def publish(self, settings, item):
        ...
        super(KatanaSessionPublishPlugin, self).publish(settings, item)
    ...
    def finalize(self, settings, item):
        ...
        super(KatanaSessionPublishPlugin, self).finalize(settings, item)

        # bump the session file to the next version
        self._save_to_next_version(item.properties["path"], item, _save_session)


def _katana_find_additional_session_dependencies():
    """
